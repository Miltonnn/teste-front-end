...
export const iconsTopo: IconTopo[] = [
    { src: icon5, alt: "Compra 100% segura", title: "Compra 100% segura", before: "Compra ", highlight: "100% segura", after: "" },
    { src: icon6, alt: "Frete grátis acima de R$ 200", title: "Frete grátis acima de R$ 200", before: "", highlight: "Frete grátis", after: " acima de R$ 200" },
    { src: icon7, alt: "Parcele suas compras", title: "Parcele suas compras", before: "", highlight: "Parcele", after: " suas compras" },
];
