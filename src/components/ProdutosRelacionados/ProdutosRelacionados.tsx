    ...
    return (
        <div>
            <div className="produtos-relacionados">
                <div className="produtos-relacionados__title">
                    <span></span>
                    <h2>Produtos relacionados</h2>
                    <span></span>
                </div>
                <a className="produtos-relacionados__item" href="#" title="Ver todos os produtos">Ver todos</a>
                <div className="produtos-relacionados__carousel">
                    <Splide
                        options={{
                            perPage: 4,
                            gap: "10px",
